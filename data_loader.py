...
import cv2
import utilss
from utilss.transforms import letterbox
...
class RSVGDataset(data.Dataset):
    def __init__(self, images_path, anno_path, imsize=640, transform= None,transforms=[], augment= False,
    ...
    def __getitem__(self, idx):
        ...
        #print('dw: ',dw)
        #print('dh: ',dh)
        #print('self.images[idx][0]: ',self.images[idx][0])
        #print('phrase_out: ',phrase_out)
